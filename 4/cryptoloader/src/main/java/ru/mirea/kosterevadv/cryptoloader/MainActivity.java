package ru.mirea.kosterevadv.cryptoloader;
...
import ru.mirea.kosterevadv.cryptoloader.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("encryptedMsg", encryptedMsg);
    ...
    public Loader<String> onCreateLoader(int id, Bundle args) {
        String encryptedMsg = args.getString("encryptedMsg");
        String key = args.getString("key");
        return new MyLoader(this, encryptedMsg, key);
    }
    ...
    private String encryption(String phrase, byte[] key) {
        Cipher cipher = null;
        try {
